...
namespace VideoClub.Controllers
{
    public class AlquileresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PeliculaId,ClienteId,FechaAlta,FechaVto,PrecioOriginal,PrecioFinal,DevolucionId")] Alquiler alquiler)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,PeliculaId,ClienteId,FechaAlta,FechaVto,PrecioOriginal,PrecioFinal,DevolucionId")] Alquiler alquiler)
        {
            if (id != alquiler.Id)
            {
                return NotFound();
