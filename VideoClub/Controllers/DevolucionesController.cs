...
namespace VideoClub.Controllers
{
    public class DevolucionesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FechaDevolucion,PrecioFinal")] Devolucion devolucion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,FechaDevolucion,PrecioFinal")] Devolucion devolucion)
        {
            if (id != devolucion.Id)
            {
                return NotFound();
